...
//routes import
import userRouter from"./routes/user.routes.js"// the name is "router" but we are able to 
                                               // use it like "userRouter because we have done export default"
                                               // in user.routes.js.


//routes declaration
app.use("/api/v1/users",userRouter)//good practice:- telling api and ites version
//this is how route work:---> http://localhost:8000/api/v1/users/register
